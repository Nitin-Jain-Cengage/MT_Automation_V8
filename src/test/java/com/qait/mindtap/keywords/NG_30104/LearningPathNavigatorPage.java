 ...
 * @author ayushgaur
 */
public class LearningPathNavigatorPage {
 ...
 * @author Mayank Gupta
 */
class LearningPathNavigator extends GetPage {
     ...
     */
    LearningPathNavigator(WebDriver driver, testdata, service) {
     ...
     */
    boolean createLearningUnit(String name, String description){
        ...
        save_btn.click()        
        waitToSync()        
        isElementDisplayed("By.xpath("//h3[contains(@class,'lpn_name')]"))
        List<WebElement> units_list = driver.findElements(By.xpath("//h3[contains(@class,'lpn_name')]"))
